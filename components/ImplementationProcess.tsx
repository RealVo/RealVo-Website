...
const ProgramStructure: React.FC = () => {
  ...
  const onContact = () => (window.location.href = '/#contact');
    ...
    <Section id="program-structure" background="light">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div
          ...
          "
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-realvo-blue text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wide shadow-md whitespace-nowrap">
            Event Programs
          </div>
          ...
          <div className="p-0 flex flex-col h-full">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="text-xl font-semibold text-realvo-charcoal dark:text-white">
                  Launch at an Event
                </h3>
              </div>
            </div>
            ...
            {/* Bullets (ImplementationProcess style, slightly larger) */}
            ...
            <Button
              ...
              className="
                w-full
                border-realvo-blue text-realvo-blue
                hover:bg-realvo-blue hover:text-white
                transition-colors
              "
              onClick={onContact}
            >
        ...
        <div
          className="
            group relative bg-white dark:bg-realvo-charcoal
            rounded-2xl border-2 border-realvo-blue
            shadow-sm hover:shadow-xl transition-shadow duration-300
            overflow-hidden flex flex-col
            p-8 pt-10
          "
