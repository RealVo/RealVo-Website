...
const tiers: PricingTier[] = [
  {
    ...
    features: ["1 Day On-site Support", "VB.tv Access (1 Month)", "Standard Branding", "Raw File Export"],
    highlight: false
  },
  {
    name: "Tier 2",
    ...
    features: ["3 Days On-site Support", "VB.tv Access (3 Months)", "Custom Branding Wrap", "Transcriptions included", "Priority Support"],
    highlight: true
  },
  {
    name: "Tier 3",
    ...
    features: ["Permanent Install", "Annual VB.tv Access", "Single Sign-On (SSO)", "Advanced Analytics", "API Access"],
    highlight: false
  }
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {tiers.map((tier, idx) => (
          ...
          >
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">{tier.name}</h3>
              <p className="text-2xl font-bold text-realvo-charcoal dark:text-white mt-2">{tier.description}</p>
              <p className="text-realvo-blue dark:text-realvo-teal font-medium mt-1">{tier.priceLabel}</p>
            </div>
