    ...
    <footer className="bg-realvo-charcoal text-white py-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-sm text-gray-400">
            ...
            <div className="hidden lg:block">
              ...
              <div className="mt-2 flex items-center justify-start lg:justify-end gap-x-4">
                ...
                <span className="text-gray-600">•</span>
                <a href="/security-and-data-protection" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors whitespace-nowrap">Security &amp; Data Protection</a>
                <span className="text-gray-600">•</span>
                <a href="/toronto-video-booth" className="hover:text-white transition-colors whitespace-nowrap">Toronto Video Booth</a>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} RealVo.
