    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 order-2 space-y-6">
          ...
          {/* Heading */}
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-realvo-charcoal leading-tight">
            Because numbers alone{' '}
            <span className="text-realvo-blue dark:text-realvo-teal">
          ...
          <div className="grid gap-5 md:gap-6">
            <div>
              ...
              <p className="mt-1 text-sm md:text-[15px] text-gray-600">
