...
function FeatureCard({ block }: { block: FeatureBlock }) {
  ...
  return (
    <div className="group rounded-3xl bg-white/90 dark:bg-slate-900/70 border border-slate-200/80 dark:border-slate-800/80 shadow-sm hover:shadow-md transition-shadow p-6 sm:p-7">
      ...
      <p className="mt-3 text-base sm:text-base text-slate-900 dark:text-slate-100">
        {block.description}
      </p>

      <ul className="mt-5 space-y-2 text-sm sm:text-sm text-slate-700 dark:text-slate-200 list-disc pl-5 marker:text-realvo-teal">
