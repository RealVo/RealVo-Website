              ...
              <div className="space-y-5 sm:space-y-6">
                <div>
                  ...
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight">
                    ...
                    <span className="block text-base sm:text-lg font-normal text-slate-500 dark:text-slate-400 mt-1">
                      A compact capture point designed for counters, desks, and reception areas — wherever people naturally pause.
                    </span>
                  </h1>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    'Quick placement + go-live',
                    'Self-guided recording UX',
                    'Ideal for receptions + waiting areas',
                    'Great for ongoing programs',
                  ].map(tag => (
                    <span
                      key={tag}
                ...
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-xl">
                  Built for offices, clinics, classrooms, libraries, and front desks, the Desktop Tablet Kiosk makes it easy
                  to capture quick stories, feedback, and reflections — without needing floor space or a full booth setup.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-2.5 text-sm sm:text-base text-slate-700 dark:text-slate-200">
                  <li className="pl-3 -indent-3">
                    • <strong>Small, approachable presence</strong> that fits naturally on counters, desks, and reception areas.
                  </li>
                  <li className="pl-3 -indent-3">
                    • <strong>Always-available capture point</strong> for quick stories, check-ins, and feedback.
                  </li>
                  <li className="pl-3 -indent-3">
                    • <strong>Self-guided prompts</strong> support clear, structured content — from quick comments to deeper reflections.
                  </li>
                  <li className="pl-3 -indent-3">
                    • <strong>Low-lift setup</strong> designed for ongoing programs, rotating locations, and shared spaces.
                  </li>
                  <li className="pl-3 -indent-3">
                    • <strong>Brand-ready presentation</strong> with on-screen UI and optional signage/skins depending on placement.
                  </li>
                  <li className="pl-3 -indent-3">
                    • <strong>Integration with VideoBooth.tv</strong> – RealVo&apos;s online content management platform for uploads, approvals, and publishing.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="text-xs sm:text-sm text-slate-700 dark:text-slate-200 grid gap-y-3 sm:gap-y-4 sm:grid-cols-2 sm:gap-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      Integrated microphone (with optional external audio support).
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      Countertop / desktop placement (no floor footprint required).
                    </p>
                  </div>
                  <div>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-20 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 px-5 sm:px-8 py-7 sm:py-9 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              <div>
                ...
                <p className="mt-2 text-xs sm:text-sm text-slate-300 max-w-xl">
                  Share your goals — we’ll help you configure the Desktop Tablet Kiosk for your space and the stories you want to capture.
                </p>
              </div>
              <a
                href="/#contact"
