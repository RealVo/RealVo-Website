...
const PortableEnclosedBooth: React.FC = () => {
  return (
    <section className="w-full bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-start">
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 max-w-xl">
              The RealVo Portable Enclosed Booth gives you a stand-out,
              sound-dampened presence on-site. It invites participants to step
              away from the noise and record honest, high-quality stories that
            ...
            <p className="text-[11px] sm:text-xs text-slate-400 dark:text-slate-500">
              *Actual throughput depends on prompt length, recording time, and
              on-site flow.
            </p>
          </div>
        </div>
            ...
            <div className="flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory">
              {[
                ...
                >
                  <img
                    src={src}
                    alt={`Portable Enclosed Booth example ${index + 1}`}
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 mb-4">
              The Portable Enclosed Booth is built to quietly draw people in,
              make them feel comfortable, and keep your production values high.
            </p>
            <ul className="space-y-2.5 text-sm sm:text-base text-slate-700 dark:text-slate-200">
              ...
              <li>
                • <strong>Premium branded exterior</strong> that feels like a
                feature, not an afterthought, in your event space.
              </li>
              <li>
              ...
              <li>
                • <strong>Fast participant flow</strong> with clear signage and
                accessible entry / exit.
              </li>
              <li>
                • <strong>Turn-key setup</strong> handled by the RealVo team or
                approved partners.
              </li>
            </ul>
            ...
            <div className="mt-6 rounded-2xl border border-emerald-300/40 dark:border-emerald-400/30 bg-emerald-50/60 dark:bg-emerald-950/20 px-4 py-3 text-xs sm:text-sm text-emerald-900 dark:text-emerald-100">
              <span className="font-semibold">Accessibility note:</span> entry
              and interior layout can be tailored to your accessibility and
          ...
          <div>
            ...
            <div className="text-xs sm:text-sm text-slate-700 dark:text-slate-200 grid gap-y-3 sm:gap-y-4 sm:grid-cols-2 sm:gap-x-6">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300">
                  10 Mbps up/down preferred (offline fallback options available)
                </p>
              </div>
              <div>
        ...
        <div className="mt-10 sm:mt-14 lg:mt-16 grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <ul className="space-y-2.5 text-sm sm:text-base text-slate-700 dark:text-slate-200">
              <li>• Leadership and employee storytelling at internal summits</li>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 px-5 sm:px-8 py-7 sm:py-9 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          <div>
            ...
            <p className="mt-2 text-xs sm:text-sm text-slate-300 max-w-xl">
              ...
              recommend the best way to use the Portable Enclosed Booth with RealVo.
            </p>
          </div>
          <a
            href="/#contact"
